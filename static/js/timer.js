window.addEventListener("load", async () => {
  ...
  try {
    await deletebuttonActive();
    await modifyButtonActive();
    await statusChange();
    async function deletebuttonActive() {
    ...
    async function modifyButtonActive() {
    ...
    addListButton.addEventListener("click", async () => {
      try {
        ...
        const today =
          +document.querySelector(".today > .date") === 0
            ? day
